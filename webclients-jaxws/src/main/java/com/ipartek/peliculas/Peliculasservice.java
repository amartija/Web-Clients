 ...
 * 
 */
@WebServiceClient(name = "peliculasservice", targetNamespace = "http://com.ipartek.formacion/types", wsdlLocation = "http://localhost:8080/webservices-jaxws/peliculaws?wsdl")
